...
def check_NewtonError(new_value, old_value):
    # has error
...
while tmp_nIteration < 10000:
    ...
    if (check_NewtonError(tmp_y, y_start) == True):
...
f = open("results/4C_result" + str([startPoint[0], startPoint[1]]) + ".txt", "w")
